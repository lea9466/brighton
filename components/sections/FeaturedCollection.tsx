      ...
      <div className="collection-shell">
        <div className="mx-auto max-w-[48rem] text-center">
          ...
          <h2
            data-reveal
            data-reveal-delay="1"
            className="mt-6 font-display text-[clamp(2.9rem,6vw,5.6rem)] leading-[0.95] tracking-[-0.03em] text-[#1a1a1a]"
          >
            {collection.title}
          </h2>
          <p
            data-reveal
            data-reveal-delay="2"
            className="mx-auto mt-7 max-w-md text-sm leading-7 text-[#68635c] sm:text-base sm:leading-8"
          >
            {collection.intro}
          </p>
        </div>
...
function CollectionItem({
  ...
  return (
    ...
    >
      <div
        data-parallax="9"
        className={`editorial-reveal group relative overflow-hidden rounded-lg bg-[#eae6df] transition-shadow duration-700 ease-out hover:shadow-[0_28px_70px_rgba(43,37,29,0.2)] ${ratio}`}
      >
        <Image
          src={item.src}
          alt={item.alt}
          fill
          sizes={sizes}
          className="object-cover saturate-[0.94] transition-[filter,transform] duration-700 ease-out group-hover:scale-[1.035] group-hover:saturate-[1.04]"
        />
      </div>
